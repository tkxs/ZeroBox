...
export const translations: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "chat.exitConfirmTitle": "退出 ZeroAgent？",
    ...
    "chat.composer.noFolder": "未选择文件夹",
    "chat.composer.selectFolder": "选择文件夹",
    "chat.composer.folderBound": "会话文件夹",
    ...
    /* ── Settings About ── */
    "settings.aboutTitle": "关于 ZeroAgent",
    ...
    "settings.aboutRestartingDesc": "ZeroAgent 正在退出并重新打开。",
    ...
    "settings.shortcutSummonDesc": "从任意位置立即唤起并聚焦 ZeroAgent 主窗口",
    ...
    "settings.shortcutPinDesc": "切换主窗口置顶，让 ZeroAgent 浮在其他应用上方",
    ...
    "settings.systemToolsBuiltinDesc":
      "ZeroAgent 在 Agent 模式下自动注册的内置工具，此处仅供查阅。",
  ...
  "en-US": {
    ...
    "chat.exitConfirmTitle": "Exit ZeroAgent?",
    ...
    "chat.composer.noFolder": "No folder selected",
    "chat.composer.selectFolder": "Select folder",
    "chat.composer.folderBound": "Conversation folder",
    ...
    /* ── Settings About ── */
    "settings.aboutTitle": "About ZeroAgent",
    ...
    "settings.aboutInstalledDesc":
      "The update package has been installed. Restart ZeroAgent to use it.",
    "settings.aboutRestarting": "Restarting app",
    "settings.aboutRestartingDesc": "ZeroAgent is quitting and opening again.",
    ...
    "settings.shortcutSummonDesc":
      "Instantly bring up and focus the ZeroAgent window from anywhere",
    ...
    "settings.shortcutPinDesc": "Toggle always-on-top so ZeroAgent floats above other apps",

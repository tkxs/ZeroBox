...
// Manually kept in sync with the WebUI twin (Radix flavor); grouped-collapse
// behavior mirrors the main page model menu in pages/chat/components/ChatHeader.tsx.
